...
class PointPillar(nn.Module):
  def __init__(self, C, data_conf, instance_seg=True, embedded_dim=16, direction_pred=True, direction_dim=37):
    ...
    self.bevencode = BevEncode(inC=128, 
  ...
  def forward(self, points, points_mask):
    ...
    topdown = self.conv_out(voxel_feature).transpose(3, 2)
